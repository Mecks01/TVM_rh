...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 19 fév. 2019 à 21:30
...
INSERT INTO `cv` (`IDCV`, `PATHCV`) VALUES
(1, '34759_CV.pdf');
...
INSERT INTO `infoprof` (`IDPROF`, `IDSERVICE`, `IDCV`, `MATRICULE`, `EMAILPROF`, `NUMPROF`, `DATEEMBAUCHE`, `DATEDEPART`) VALUES
(1, 1, 1, 34759, 'rmaokotara01@gmail.com', '0332852645', 'Mardi 19/02/2019', NULL);
...
INSERT INTO `personne` (`IDPERS`, `NOMPERS`, `PRENOMPERS`, `CIVILITE`, `DATENAISSANCE`, `ADRESSEPERS`, `NUMPERS`, `EMAILPERS`, `AVATAR`, `PASSWORD`, `NATIONALITE`, `NBENFANTS`) VALUES
(1, 'RANDRIAMANANA', 'Mendrika', 'Célibataire', 'Jeudi  07/02/2019', 'Manakambahinyy Antananarivo', '0342424687', 'rmecks01@gmail.com', 'defaultImg.png', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Malagasy', 0),
(3, 'RALKJIA', 'Grggd', 'Célibataire', 'Samedi  09/02/2019', 'gdgdrgr Antsirabe', '3333333333', 'gdgrr@jygy.hgk', 'defaultImg.png', '9cf95dacd226dcf43da376cdb6cbba7035218921', 'Malagasy', 3);
...
(1, 'Informatique', 'Dev Web', 'Stagiaire');
...
--
ALTER TABLE `cv`
  MODIFY `IDCV` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
